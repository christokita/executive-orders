#' Format Raw Output from lda.collapsed.gibbs.sampler()  or ida.lda.collabsed.gibbs.sampler()
#' @description extracts outputs from LDA model estimated with "lda" package by Jonathan Chang or IDA's idaTopicModels package which builds off of "lda"
#' @param lda.result The list value returned by lda.collapsed.gibbs.sampler()  or ida.lda.collabsed.gibbs.sampler()
